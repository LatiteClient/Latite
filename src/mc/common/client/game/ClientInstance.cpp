...
SDK::GuiData* SDK::ClientInstance::getGuiData() {
    ...
    case V1_19_51:
        return hat::member_at<GuiData*>(this, 0x500);
    default:
        ...
        if (internalVers >= V1_21_70) {
            return hat::member_at<GuiData*>(this, 0x5B0);
        }
        if (internalVers >= V1_21_40) {
            return hat::member_at<GuiData*>(this, 0x590);
        }
        return hat::member_at<GuiData*>(this, 0x588);
    }
    return nullptr;
}
