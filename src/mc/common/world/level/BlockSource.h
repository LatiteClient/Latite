...
namespace SDK {
    ...
    public:
        ...
        virtual void fetchCollisionShapes(std::vector<AABB, std::allocator<AABB>>&, AABB const&, float*, bool,
                                          void* /*optional_ref<GetCollisionShapeInterface const>*/) const = 0; // 0x11
        virtual void
        getTallestCollisionShape(AABB const&, float*, bool,
        ...
        virtual void setBlock(BlockPos const&, class Block const&, int, class ActorBlockSyncMessage const*,
                              class Actor*) = 0;                                                      // 0x19
