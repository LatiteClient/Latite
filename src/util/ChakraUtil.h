...
public:
    ...
    struct ParamContainer {
        ...
        ParamContainer(JsValueRef val, JsValueType type, bool optional = false)
            : val(val)
            , type(type)
            , isOptional(optional) {}
    };
    ...
    static JsErrorCode CallFunction(JsValueRef func, JsValueRef* arguments, unsigned short argumentCount,
                                    JsValueRef* result);
