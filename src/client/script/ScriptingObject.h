...
public:
    ...
    // you NEED to call initialize shortly after constructing it or there is a chance the garbage collector will do a
    // funny
    ScriptingObject(int id, const wchar_t* name)
        : objName(name) {
        this->id = id;
