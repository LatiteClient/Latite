...
public:
	static JsValueRef CALLBACK jsConstructor2(JsValueRef callee, bool isConstructor,
		...
		auto jsm = new JsTextModule(util::WStrToStr(Chakra::GetString(arguments[1])), Chakra::GetString(arguments[2]), Chakra::GetString(arguments[3]), Chakra::GetInt(arguments[4]));
