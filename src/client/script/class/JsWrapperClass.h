...
protected:
    static JsValueRef CALLBACK jsNoConstructor(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
    ...
    static JsValueRef CALLBACK defaultToString(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                               unsigned short argCount, void* callbackState) {
        auto thi = reinterpret_cast<JsWrapperClass*>(callbackState);
