...
JsValueRef JsHudModuleClass::hudModuleGetRect(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
...
JsValueRef JsHudModuleClass::hudModuleSetRect(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                              unsigned short argCount, void* callbackState) {
...
JsValueRef JsHudModuleClass::hudModuleSetBounds(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                unsigned short argCount, void* callbackState) {
...
JsValueRef JsHudModuleClass::hudModuleGetSize(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                              unsigned short argCount, void* callbackState) {
    JsHUDModule* mod;
    JS::JsGetExternalData(arguments[0], reinterpret_cast<void**>(&mod));
    if (!mod) {
...
JsValueRef JsHudModuleClass::hudModuleSetSize(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                              unsigned short argCount, void* callbackState) {
    if (!Chakra::VerifyArgCount(argCount, 2)) return Chakra::GetUndefined();
