...
protected:
    static JsValueRef CALLBACK jsConstructor(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
        ...
        auto jsm = new JsModule(util::WStrToStr(Chakra::GetString(arguments[1])), Chakra::GetString(arguments[2]),
                                Chakra::GetString(arguments[3]), Chakra::GetInt(arguments[4]));
    ...
    static JsValueRef CALLBACK moduleIsEnabled(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                               unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleSetEnabled(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleIsBlocked(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                               unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleSetOnEvent(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleGetSettings(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                 unsigned short argCount, void* callbackState);

    static JsValueRef CALLBACK moduleAddBoolSetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                    unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleAddNumberSetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                      unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleAddKeySetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                   unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleAddTextSetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                    unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleAddColorSetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                     unsigned short argCount, void* callbackState);
    static JsValueRef CALLBACK moduleAddEnumSetting(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                    unsigned short argCount, void* callbackState);

public:
    inline static const wchar_t* class_name = L"Module";

    JsModuleClass(class JsScript* owner, const wchar_t* name = class_name, bool defConstruct = true)
    ...
    void prepareFunctions() override {
        ...
        Chakra::DefineFunc(prototype, moduleAddColorSetting, L"addColorSetting", this);
        Chakra::DefineFunc(prototype, moduleAddEnumSetting, L"addEnumSetting", this);
    };
};
