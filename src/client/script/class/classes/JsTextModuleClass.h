...
public:
    static JsValueRef CALLBACK jsConstructor2(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
        ...
        auto jsm = new JsTextModule(util::WStrToStr(Chakra::GetString(arguments[1])), Chakra::GetString(arguments[2]),
...
private:
    static JsValueRef CALLBACK getLastTextCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                   unsigned short argCount, void* callbackState);
};
