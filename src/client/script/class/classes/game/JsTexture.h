...
public:
    ...
    [[nodiscard]] bool isMinecraftTexture() { return this->mcTexture.has_value(); }

    [[nodiscard]] bool hasTexture() { return (mcTexture.has_value() && mcTexture->resourceLocation) || d2dTexture; }
