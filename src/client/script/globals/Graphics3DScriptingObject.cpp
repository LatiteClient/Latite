...
void Graphics3DScriptingObject::onRenderLevel(Event& evG) {
    ...
    *screenContext->shaderColor = { 1.f, 1.f, 1.f, 1.f };
    ...
    for (auto& command : commands) {
        ...
        SDK::MeshHelpers::renderMeshImmediately(screenContext, tess,
...
JsValueRef Graphics3DScriptingObject::drawLineCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
...
JsValueRef Graphics3DScriptingObject::drawTriangleCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                           unsigned short argCount, void* callbackState) {
    if (!Chakra::VerifyArgCount(argCount, 4)) return JS_INVALID_REFERENCE;
    if (!Chakra::VerifyParameters(
            { { arguments[1], JsObject }, { arguments[2], JsObject }, { arguments[3], JsObject } }))
        return JS_INVALID_REFERENCE;
    auto obj = reinterpret_cast<Graphics3DScriptingObject*>(callbackState);
...
JsValueRef Graphics3DScriptingObject::drawQuadCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                       unsigned short argCount, void* callbackState) {
...
JsValueRef Graphics3DScriptingObject::finishCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                     unsigned short argCount, void* callbackState) {
    if (!Chakra::VerifyParameters({ { Chakra::TryGet(arguments, argCount, 1), JsBoolean, true } }))
        return JS_INVALID_REFERENCE;
...
JsValueRef Graphics3DScriptingObject::setColorCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                       unsigned short argCount, void* callbackState) {
...
JsValueRef Graphics3DScriptingObject::setColorsCallback(JsValueRef callee, bool isConstructor, JsValueRef* arguments,
                                                        unsigned short argCount, void* callbackState) {
    if (!Chakra::VerifyArgCount(argCount, 5)) return JS_INVALID_REFERENCE;
    if (!Chakra::VerifyParameters({ { arguments[1], JsObject } })) return JS_INVALID_REFERENCE;
