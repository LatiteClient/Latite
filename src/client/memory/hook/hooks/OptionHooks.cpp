...
OptionHooks::OptionHooks() {
    ...
    getPerspectiveHook =
        addHook(Signatures::Options_getPerspective.result, Options_getPerspective, "Options::getPerspective");
    getHideHandHook = addHook(Signatures::Options_getHideHand.result, Options_getHideHand, "Options::getHideHand");
    // getSensitivityHook = addHook(Signatures::Options_getSensitivity.result, Options_getSensitivity,
