...
#include "mc/common/network/packet/SetScorePacket.h"
#include "mc/common/network/packet/ModalFormRequestPacket.h"
...
class PacketHooks : public HookGroup {
    ...
    static void PacketHandlerDispatcherInstance_handle(void* instance, void* networkIdentifier, void* netEventCallback,
