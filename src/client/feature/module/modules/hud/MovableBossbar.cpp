...
MovableBossbar::MovableBossbar()
    : HUDModule("MovableBossbar", LocalizeString::get("client.hudmodule.movableBossbar.name"),
                LocalizeString::get("client.hudmodule.movableBossbar.desc"), HUD, 0, false) {
    listen<RenderLayerEvent>((EventListenerFunc)&MovableBossbar::onRenderLayer, true,
