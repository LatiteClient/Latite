...
English::English() {
    English::strings = {
        ...
        { "client.module.keystrokes.name", L"Keystrokes" },
        { "client.module.keystrokes.mouseButtons.name", L"Mouse Buttons" },
        { "client.module.keystrokes.showCps.name", L"CPS" },
        { "client.module.keystrokes.spaceBar.name", L"Space Bar" },
        { "client.module.keystrokes.border.name", L"Border" },
        { "client.module.keystrokes.showSneak.name", L"Sneak Key" },
        { "client.module.keystrokes.radius.name", L"Radius" },
        { "client.module.keystrokes.textSize.name", L"Text Size" },
        { "client.module.keystrokes.keySize.name", L"Key Size" },
        { "client.module.keystrokes.spaceSize.name", L"Space Bar" },
        { "client.module.keystrokes.mouseButtonHeight.name", L"Mouse Button Height" },
        { "client.module.keystrokes.padding.name", L"Padding" },
        { "client.module.keystrokes.borderLength.name", L"Border Length" },
        { "client.module.keystrokes.transition.name", L"Transition (0 = No Transition)" },
        { "client.module.keystrokes.borderCol.name", L"Border Color" },
        { "client.module.keystrokes.pressedCol.name", L"Pressed Color" },
        { "client.module.keystrokes.unpressedCol.name", L"Unpressed Color" },
        { "client.module.keystrokes.ptCol.name", L"Pressed Text Color" },
        { "client.module.keystrokes.uptCol.name", L"Unpressed Text Color" },
        { "client.module.keystrokes.desc", L"Shows movement keys and states." },
        { "client.module.keystrokes.mouseButtons.desc", L"Show mouse buttons" },
        { "client.module.keystrokes.showCps.desc", L"Show clicks per second" },
        { "client.module.keystrokes.spaceBar.desc", L"Space bar" },
        { "client.module.keystrokes.border.desc", L"Border" },
        { "client.module.keystrokes.showSneak.desc", L"Shows the sneak key" },
        { "client.module.keystrokes.radius.desc", L"How round the buttons are" },
        { "client.module.keystrokes.textSize.desc", L"Text Size" },
        { "client.module.keystrokes.keySize.desc", L"Key Size" },
        { "client.module.keystrokes.spaceSize.desc", L"Spacebar Size" },
        { "client.module.keystrokes.mouseButtonHeight.desc", L"Mouse Button Height" },
        { "client.module.keystrokes.padding.desc", L"Padding between keys" },
        { "client.module.keystrokes.borderLength.desc", L"The border length" },
        { "client.module.keystrokes.transition.desc", L"The smooth color transition (0 for no transition)" },
        { "client.module.keystrokes.borderCol.desc", L"The color of the border" },
        { "client.module.keystrokes.pressedCol.desc", L"The key color when pressed" },
        { "client.module.keystrokes.unpressedCol.desc", L"The key color when not pressed" },
        { "client.module.keystrokes.ptCol.desc", L"The text color when pressed" },
        { "client.module.keystrokes.uptCol.desc", L"The text color when not pressed" },
