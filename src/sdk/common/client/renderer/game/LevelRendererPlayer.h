...
namespace SDK {
	...
	private:
		MVCLASS_FIELD(class MaterialPtr*, selectionOverlayMaterial, 0xF08, 0xEF0, 0xEF0, 0x14E0, 0x1538);
		MVCLASS_FIELD(class MaterialPtr*, selectionBoxMaterial, 0x2F0, 0xF50, 0xF50, 0x15A0, 0x1598);
