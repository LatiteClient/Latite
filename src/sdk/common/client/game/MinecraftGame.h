...
namespace SDK {
	...
	private:
		MVCLASS_FIELD(class FontRepository**, fontRepo, 0xE58, 0xE38, 0xE08, 0xEB0, 0xDE0, 0xE08, 0xE00, 0xF60, 0xF30, 0xF20, 0x110, 0xF88);
	public:
		MVCLASS_FIELD(class Font*, minecraftFont, 0xE60, 0xE40, 0xE10, 0xEB8, 0xDE8, 0xE18, 0xE10, 0xF70, 0xF40, 0xF30, 0x120, 0xF78);
