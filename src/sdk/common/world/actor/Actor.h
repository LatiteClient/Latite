...
namespace SDK {
	...
	public:
		...
		MVCLASS_FIELD(int32_t, ticksExisted, 0x208, 0x200, 0x200, 0x2A8, 0x24C);
		MVCLASS_FIELD(int32_t, invulnerableTime, 0x20C, 0x204, 0x204, 0x2AC, 0x250); // Mob::hurtEffects
		// @dump-wbds Actor::getDimensionConst, 9, -8
		MVCLASS_FIELD(std::shared_ptr<class Dimension>, dimension, 0x240, 0x250, 0x250, 0x360, 0x300);
		MVCLASS_FIELD(StateVectorComponent*, stateVector, 0x290, 0x2A0, 0x2A0, 0, 0x350);
		MVCLASS_FIELD(AABBShapeComponent*, aabbShape, 0x298, 0x2A8, 0x2A8, 0, 0x358);
		MVCLASS_FIELD(ActorRotationComponent*, actorRotation, 0x2A0, 0x2B0, 0x2B0, 0, 0x360);
		// @dump-wbds Actor::getMolangVariables, 3
		MVCLASS_FIELD(MolangVariableMap, molangVariableMap, 0x400, 0x450, 0, 0, 0);
