...
std::vector<SDK::Actor*> SDK::Level::getRuntimeActorList() {
	...
	static int index = mvGetOffset<0x13B, 0x13A, 0x139, 0x135, 0x135, 0x136, 0x134, 0x132, 0x134, 0x117, 0x117, 0x116, 0x125, 0x125, 0x12D, 0x13C>();
...
std::unordered_map<UUID, SDK::PlayerListEntry>* SDK::Level::getPlayerList() {
	if (internalVers >= SDK::V1_21_40) {
		return *reinterpret_cast<std::unordered_map<UUID, SDK::PlayerListEntry>**>(reinterpret_cast<uintptr_t>(this) + 0x4F8);
	}
...
SDK::HitResult* SDK::Level::getHitResult() {
	static int index = mvGetOffset<0x145, 0x144, 0x143, 0x13F, 0x13F, 0x140, 0x13E, 0x13C, 0x13E, 0x121, 0x121, 0x120, 0x12E, 0x12E, 0x139, 0x148>();
	return memory::callVirtual<HitResult*>(this, index);
}

SDK::HitResult* SDK::Level::getLiquidHitResult() {
	static int index = mvGetOffset<0x146, 0x145, 0x144, 0x140, 0x140, 0x141, 0x13F, 0x13D, 0x13F, 0x122, 0x122, 0x121, 0x12F, 0x12F, 0x13A, 0x149>();
...
bool SDK::Level::isClientSide() {
	return memory::callVirtual<bool>(this, SDK::mvGetOffset<0x134, 0x133, 0x132, 0x12E, 0x12E, 0x12F, 0x12D, 0x12B, 0x12C, 0x111, 0x111, 0x110, 0x11F, 0x11F, 0x12B, 0x127>());
}
