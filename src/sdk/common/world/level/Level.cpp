...
SDK::HitResult* SDK::Level::getHitResult() {
	static int index = mvGetOffset<0x13E, 0x121, 0x121, 0x120, 0x12E, 0x12E, 0x139, 0x148>();
...
bool SDK::Level::isClientSide() {
	return memory::callVirtual<bool>(this, SDK::mvGetOffset<0x12C, 0x111, 0x111, 0x110, 0x11F, 0x11F, 0x12B, 0x127>());
}
