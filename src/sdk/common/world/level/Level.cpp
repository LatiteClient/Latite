...
std::vector<SDK::Actor*> SDK::Level::getRuntimeActorList() {
	...
	static int index = mvGetOffset<0x116, 0x125, 0x125, 0x12D, 0x13C>();
...
bool SDK::Level::isClientSide() {
	return memory::callVirtual<bool>(this, SDK::mvGetOffset<0x110, 0x11F, 0x11F, 0x12B, 0x127>());
}
