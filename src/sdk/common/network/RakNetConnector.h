...
namespace SDK {
	...
	public:
		...
		MVCLASS_FIELD(std::string, ipAddress, 0x3E8, 0x378, 0x378, 0x378, 0x378, 0x370, 0x370, 0x438, 0x438, 0x438, 0x3D0, 0x438);
		MVCLASS_FIELD(std::string, dns, 0x400, 0x398, 0x398, 0x398, 0x398, 0x390, 0x390, 0x458, 0x458, 0x458, 0x3F0, 0x458);
